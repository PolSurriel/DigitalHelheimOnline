...
function coop_battle_update(){
    ...
    if (!in_host_mode && pj.alive && !pj.inmune && !restorer.following && restorer.reference != pj && Collider2D.detector.circleToPoint(restorer.x, restorer.y, restorer.distance_to_infect, pj.x, pj.y) ){
        // AVISAR AL SERVIDOR
